package com.benz.find.benz.widget;
...
public class ViewAspectRatioMeasurer {
    ...
    public void measure(int widthMeasureSpec, int heightMeasureSpec, double aspectRatio) {
        ...
        if ( heightMode == MeasureSpec.EXACTLY && widthMode == MeasureSpec.EXACTLY ) {
             ...
             */
            measuredWidth = (int)Math.ceil( Math.min( widthSize, heightSize * aspectRatio ));
             ...
             */
            measuredHeight = (int)Math.ceil( Math.min( heightSize, widthSize / aspectRatio ));
